        ...
        (quote! {
                ...
                #wasm_bindgen::JsValue
            {
                fn from(value: #name) -> Self {
                    ...
                    #[cfg(not(all(target_arch = "wasm32", any(target_os = "unknown", target_os = "none", target_os = "wasi"))))]
...
impl ToTokens for ast::StructField {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        (quote! {
            ...
            const _: () = {
                #wasm_bindgen::__wbindgen_coverage! {
                #[cfg_attr(all(target_arch = "wasm32", any(target_os = "unknown", target_os = "none", target_os = "wasi")), no_mangle)]
                #[doc(hidden)]
    ...
    fn try_to_tokens(self: &ast::Export, into: &mut TokenStream) -> Result<(), Diagnostic> {
        ...
        (quote! {
            ...
            const _: () = {
                ...
                #(#attrs)*
                #[cfg_attr(
                    all(target_arch = "wasm32", any(target_os = "unknown", target_os = "none", target_os = "wasi")),
